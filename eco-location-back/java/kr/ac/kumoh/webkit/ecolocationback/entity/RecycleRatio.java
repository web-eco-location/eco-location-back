...
@Data
@Table(name = "recycle_ratio")
@NoArgsConstructor(access = AccessLevel.PUBLIC)
@Entity
public class RecycleRatio {
	@Id
    ...
    @Builder
    public RecycleRatio(String time, String area, String srcNucl, String srcBcoal, String srcHcoal, String srcOil,
